      ...
      <MaxWidthWrapper>
        <div className="relative z-10 grid grid-cols-6 gap-3">
          ...
          <div className="relative col-span-full flex overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-2 ">
            <div className="relative m-auto size-fit">
              <div className="relative flex h-24 w-56 items-center">
                ...
                <span className="mx-auto block w-fit bg-gradient-to-r from-secondary to-secondary/80 bg-clip-text font-heading text-5xl font-bold text-transparent">
                  500+
                </span>
              </div>
          ...
          <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
            <div>
              <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border before:bg-secondary/20 dark:before:border-white/5">
                <Shield className="m-auto h-fit w-16 text-secondary" />
              </div>
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                ...
                <p className="text-muted-foreground">
                  Automatic SSL certificate monitoring and renewal alerts.
                  Never lose visitors due to expired certificates.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
            <div>
              ...
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                ...
                <p className="text-muted-foreground">
                  Manage DNS records across all providers from one dashboard.
                  Updates propagate globally in seconds.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Never lose a domain again. Smart alerts 90, 30, and 7 days
                    before expiration with one-click renewal.
                  </p>
                </div>
              </div>
              <div className="relative -mb-10 -mr-10 mt-8 h-fit rounded-tl-xl border bg-muted/30 pt-6 sm:ml-6 sm:mt-auto">
                ...
                <svg
                  className="w-full text-secondary/60 sm:w-[150%]"
                  viewBox="0 0 366 231"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    safely on domain management.
                  </p>
                </div>
              </div>
              <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-secondary/50 sm:-my-8 sm:-mr-8">
